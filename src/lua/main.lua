local function set_pos() 
    ...
    local key_name={
        ...
        {'caps',    57,'a',     4,  's',    22,'d',7, 'f',    9,  'g',    10,'h', 11,'j',13,'k',14,'l',15,';',51,'\'',52,'enter',40,'enter',40},
        {'lshift',  225,'lshift',  225,'z',    29, 'x',    27,'c',6, 'v',    25, 'b',    5,'n',  17,'m',16,',',54,'.',55,'/',56,'none',0,'rshift',229},
        {'lctrl',   224,'lwin',227, 'UpArrow1',  82,'DownArrow1',81,'lalt',226,'space',44,'none',0,'none',0,'lctrl',224,'my4',254,'my5',255},
    }
