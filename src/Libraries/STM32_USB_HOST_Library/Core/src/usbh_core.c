...
HOST_State Tab_State_Machine[100];//M("?");
...
* @retval None
*/
USBH_Status USBH_HID_ClassRequest(USB_OTG_CORE_HANDLE *pdev ,
                                     void *phost);
void USBH_Process(USB_OTG_CORE_HANDLE *pdev , USBH_HOST *phost)
{
    ...
    //////////////////////////////////////
    if(Tab_State_Machine_incr<100)
    {
        if(Previous_status != (unsigned int)phost->gState)
        {
            Tab_State_Machine[Tab_State_Machine_incr++] = phost->gState;
            Previous_status = (unsigned int)phost->gState;
        }
    }
    //////////////////////////////////////
    switch (phost->gState)
    ...
    case HOST_DEV_ATTACHED :
        ...
        /* Reset USB Device */
        if ( HCD_ResetPort(pdev) == 0)//M("may be source")
        {
    ...
    case HOST_CLASS_REQUEST:
         //DBG ("M-HOST_CLASS_REQUEST\r\n");
        /* process class standard contol requests state machine */
        status = phost->class_cb->Requests(pdev, phost);
   //     USBH_HID_ClassRequest2(pdev, phost);
        if(status == USBH_OK)
        {
    ...
    case HOST_CTRL_XFER:
        //DBG ("M-HOST_CTRL_XFER\r\n");
        /* process control transfer state machine */
        USBH_HandleControl(pdev, phost);
        break;

    case HOST_SUSPENDED:
            //DBG ("M-HOST_SUSPENDED\r\n");
        break;

    case HOST_ERROR_STATE:
         //DBG ("M-HOST_ERROR_STATE\r\n");
...
static USBH_Status USBH_HandleEnum(USB_OTG_CORE_HANDLE *pdev, USBH_HOST *phost)
{
    ...
    case ENUM_GET_MFC_STRING_DESC:
        //DBG ("M-ENUM_GET_MFC_STRING_DESC\r\n");
    ...
    case ENUM_GET_PRODUCT_STRING_DESC:
         //DBG ("M-ENUM_GET_PRODUCT_STRING_DESC\r\n");
...
//DBG("Control.state-%d\r\n",phost->Control.state);
    ...
    case CTRL_SETUP_WAIT:
       ...
       //DBG("URB_Status-%d\r\n",URB_Status);
        ...
        else if(URB_Status == CTRL_IDLE)
        {
         //   phost->gState=HOST_DEV_ATTACHED;
          //  phost->RequestState=1;
            err_flag=1;
