...
u8 MSD_Init(void)
{
  u32 i = 0;
    ...
    SPI2_Init();
     SPI2_SetSpeed(SPI_SPEED_256);//���õ�����ģʽ
...
u8 MSD_WriteBuffer1(u8* pBuffer, u32 WriteAddr, u32 NumByteToWrite)
{
    ...
    {        
        ...
        SPI2_ReadWriteByte(24 | 0x40);//�ֱ�д������
        ...
        do
        {
          ...
          while(SPI2_ReadWriteByte(0XFF)==0);//�ȴ�д�����
...
u8 MSD_GoIdleState(void)
{
  ...
  /* Send dummy byte 0xFF */
  MSD_WriteByte(DUMMY);
     SPI2_SetSpeed(SPI_SPEED_4);//���õ�����ģʽ
  return MSD_RESPONSE_NO_ERROR;
}
