...
#define PAin(a) ((IOAB->IDR&(1<<a))>0)
#define PBin(a) ((IOBB->IDR&(1<<a))>0)
#define PCin(a) ((IOCB->IDR&(1<<a))>0)
#define PDin(a) ((IODB->IDR&(1<<a))>0)
#define PEin(a) ((IOEB->IDR&(1<<a))>0)
#define PFin(a) ((IOFB->IDR&(1<<a))>0)
#define PGin(a) ((IOGB->IDR&(1<<a))>0)
#define PHin(a) ((IOHB->IDR&(1<<a))>0)
#define PIin(a) ((IOIB->IDR&(1<<a))>0)
